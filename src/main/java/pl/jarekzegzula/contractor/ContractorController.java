...
public class ContractorController {
  ...
  @PostMapping
  public Result addContractor(@Valid @RequestBody NewContractorRequest request)
  ...
  public Result updateContractorHourlyRate(
      @PathVariable("contractorId") Integer id,
  ...
  public Result updateContractorMonthlyHourLimit(
      @PathVariable("contractorId") Integer id,
  ...
  public Result updateContractorOvertimeMultiplier(
      @PathVariable("contractorId") Integer id,
  ...
  public Result updateContractorPrice(
      @PathVariable("contractorId") Integer id,
  ...
  public Result updateContractorOvertime(
      @PathVariable("contractorId") Integer id,
  ...
  public Result updateContractorContractType(
      @PathVariable("contractorId") Integer id,
