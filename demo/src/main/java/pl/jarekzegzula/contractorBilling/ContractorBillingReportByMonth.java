...
public class ContractorBillingReportByMonth {
    ...
    public ContractorBillingReportByMonth(List<ContractorBillingDTO> contractorsByYearAndMonth, Year year, Month month) {
        ...
        this.expense = Calculator.sumBigDecimalFieldFromContractorBillingList(
                contractorsByYearAndMonth, ContractorBillingDTO::getContractorRemuneration);
        this.income = Calculator.sumBigDecimalFieldFromContractorBillingList(
