...
public class ContractorService {
  ...
  public Contractor getContractorById(Integer id) {
    return this.contractorRepository
        .findById(id)
        .orElseThrow(() -> new ObjectNotFoundException("contractor", id));
  }
  ...
  public Contractor addNewContractor(NewContractorRequest request) {
    ...
    if (!contractorRepository.existsByFirstNameAndLastName(
  ...
  public void updateContractorHourlyRateAndMonthlyEarnings(
      UpdateContractorHourlyRateRequest updateRequest, Integer id) {

    Contractor contractor = findContractor(id);

    if (!Objects.equals(contractor.getHourlyRate(), updateRequest.hourlyRate())
        && updateRequest.hourlyRate() >= ZERO) {
      contractor.setHourlyRate(updateRequest.hourlyRate());
      contractor.setMonthlyEarnings(
          calculateMonthlyEarningsForContractor(
              updateRequest.hourlyRate(), contractor.getMonthlyHourLimit()));
  ...
  public void updateContractorOvertimeMultiplier(
      UpdateContractorOvertimeMultiplier updateRequest, Integer id) {
  ...
  public void updateMonthlyHourLimitAndMonthlyEarnings(
      UpdateMonthlyHourLimitRequest updateRequest, Integer id) {
    ...
    if (!Objects.equals(contractor.getMonthlyHourLimit(), updateRequest.hours())
      ...
      throw new ValueUnchangedException(
          "Contractor hour limit remains the same or the value is incorrect");
    }
  }

  public void updateContractorHourPrice(
      UpdateContractorHourPriceRequest updateRequest, Integer id) {
    ...
    if (!Objects.equals(contractor.getContractorHourPrice(), updateRequest.hourPrice())
      ...
      throw new ValueUnchangedException(
          "Contractor hour price remains the same or the value is incorrect");
    }
  }
  ...
  public void updateContractType(UpdateContractorContractTypeRequest request, Integer id) {
    ...
    if (!ContractType.isValidContractTypeValue(request.contractType())) {
      throw new IllegalContractTypeArgument(
          "Invalid ContractType value: " + request.contractType());
    }
