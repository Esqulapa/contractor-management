...
class ContractorControllerTest {
    ...
    void testUpdateContractorHourlyRateSuccess() throws Exception {
        ...
        doNothing().when(contractorService).updateContractorHourlyRateAndMonthlyEarnings(updateRequest, contractorId);

        //When and Then
        mockMvc.perform(put(this.baseUrl + "/contractor/hourly-rate/{contractorId}", contractorId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(json))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(200))
    ...
    void testUpdateContractorHourlyRateErrorWithNonExistentId() throws Exception {
        ...
        doThrow(new ObjectNotFoundException("contractor",contractorId)).when(this.contractorService).updateContractorHourlyRateAndMonthlyEarnings(updateRequest,contractorId);
        //When and Than
       mockMvc.perform(put(this.baseUrl + "/contractor/hourly-rate/{contractorId}", contractorId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(json))
    ...
    void testUpdateContractorHourPriceSuccess() throws Exception {
        ...
        //When and Then
        mockMvc.perform(put(this.baseUrl + "/contractor/hour-price/{contractorId}", contractorId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(json))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(200))
    ...
    void testUpdateContractorPriceErrorWithNonExistentId() throws Exception {
        ...
        doThrow(new ObjectNotFoundException("contractor",contractorId))
                .when(this.contractorService).updateContractorHourPrice(updateRequest,contractorId);
        //When and Than
        mockMvc.perform(put(this.baseUrl + "/contractor/hour-price/{contractorId}", contractorId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(json))
    ...
    void testUpdateContractorContractType() throws Exception {
        ...
        UpdateContractorContractTypeRequest updateContractorContractTypeRequest = new UpdateContractorContractTypeRequest(1);

        String json = objectMapper.writeValueAsString(updateContractorContractTypeRequest);



        doNothing().when(contractorService).updateContractType(updateContractorContractTypeRequest, contractorId);

        //When and Then
        mockMvc.perform(put(this.baseUrl + "/contractor/contract-type/{contractorId}", contractorId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(json))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(200))
    ...
    void testUpdateContractorContractTypeWithNonExistentId() throws Exception {
        ...
        doThrow(new ObjectNotFoundException("contractor",contractorId))
                .when(this.contractorService).updateContractType(updateContractorContractTypeRequest,contractorId);
        //When and Than
        mockMvc.perform(put(this.baseUrl + "/contractor/contract-type/{contractorId}", contractorId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(json))
